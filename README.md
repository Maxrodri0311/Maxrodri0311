...
| **[TechMind](https://github.com/Maxrodri0311/techmind-ai-platform)** | *FastAPI • ONNX INT8 • Spring Boot • OCI* | **[🏛️ Architecture Spec](https://github.com/Maxrodri0311/techmind-ai-platform)** | Dual-Subnet OCI Cloud DMZ, local ONNX INT8 inference (<18ms), Groq LPU resilient cascading. |
